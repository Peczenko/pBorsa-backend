...
public class SystemCredentialsService {
    ...
    @Cacheable(
            ...
            key = "T(com.pborsa.domain.constants.SystemConstants).SYSTEM_USER_ID",
     ...
     */
    @Caching(evict = {
            @CacheEvict(value = CacheNames.API_CREDENTIALS, key = "T(com.pborsa.domain.constants.SystemConstants).SYSTEM_USER_ID", cacheManager = "apiCredentialsCacheManager"),
            @CacheEvict(value = CacheNames.ALPACA_CLIENTS, key = "T(com.pborsa.domain.constants.SystemConstants).SYSTEM_USER_ID", cacheManager = "apiCredentialsCacheManager")
    })
    @Transactional
