...
import com.pborsa.trading.mapper.OrderMapper;
...
import static com.pborsa.domain.dto.trading.OrderResponse.buildRejectedOrderResponse;
...
public class OrderService {
     ...
     */
    private OrderSide convertOrderSide(com.pborsa.domain.dto.trading.OrderSide side) {
        if (side == null) {
            return null;
        }
     ...
     */
    private OrderType convertOrderType(com.pborsa.domain.dto.trading.OrderType type) {
        if (type == null) {
            return null;
        }
     ...
     */
    private TimeInForce convertTimeInForce(com.pborsa.domain.dto.trading.TimeInForce tif) {
        if (tif == null) {
            return null;
        }
