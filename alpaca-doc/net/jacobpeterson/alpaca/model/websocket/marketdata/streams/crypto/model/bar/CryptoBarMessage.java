...
package net.jacobpeterson.alpaca.model.websocket.marketdata.streams.crypto.model.bar;
    ...
    implements Serializable
{
    ...
    @Expose
    private Double vwap;
    private final static long serialVersionUID = -2989621761553501650L;
     ...
     *     The timestamp.
     */
    public CryptoBarMessage(String symbol, Double open, Double high, Double low, Double close, OffsetDateTime timestamp, Long volume, Long tradeCount, Double vwap) {
        super();
        this.symbol = symbol;
        this.open = open;
        this.high = high;
    ...
    public CryptoBarMessage withSymbol(String symbol) {
        this.symbol = symbol;
        return this;
    }
    ...
    public CryptoBarMessage withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public CryptoBarMessage withHigh(Double high) {
        this.high = high;
        return this;
    }
    ...
    public CryptoBarMessage withLow(Double low) {
        this.low = low;
        return this;
    }
    ...
    public CryptoBarMessage withClose(Double close) {
        this.close = close;
        return this;
    }
    ...
    public CryptoBarMessage withTimestamp(OffsetDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public CryptoBarMessage withVolume(Long volume) {
        this.volume = volume;
        return this;
    }
    ...
    public CryptoBarMessage withTradeCount(Long tradeCount) {
        this.tradeCount = tradeCount;
        return this;
    }
    ...
    public CryptoBarMessage withVwap(Double vwap) {
        this.vwap = vwap;
        return this;
    }
