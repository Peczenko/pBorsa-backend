...
public class OptionBar {
  ...
  public OptionBar t(OffsetDateTime t) {
    this.t = t;
    return this;
  }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonElement == null) {
        if (!OptionBar.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptionBar is not found in the empty JSON string", OptionBar.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptionBar.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptionBar` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
