...
public class StockQuotesRespSingle {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.symbol, stockQuotesRespSingle.symbol) &&
        Objects.equals(this.quotes, stockQuotesRespSingle.quotes) &&
        Objects.equals(this.currency, stockQuotesRespSingle.currency) &&
        Objects.equals(this.nextPageToken, stockQuotesRespSingle.nextPageToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(symbol, quotes, currency, nextPageToken);
  }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonElement == null) {
        if (!StockQuotesRespSingle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StockQuotesRespSingle is not found in the empty JSON string", StockQuotesRespSingle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StockQuotesRespSingle.openapiFields.contains(entry.getKey())) {
