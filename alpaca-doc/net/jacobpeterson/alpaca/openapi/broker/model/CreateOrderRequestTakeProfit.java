...
public class CreateOrderRequestTakeProfit {
  ...
  public CreateOrderRequestTakeProfit limitPrice(BigDecimal limitPrice) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(limitPrice);
  }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonElement == null) {
        if (!CreateOrderRequestTakeProfit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateOrderRequestTakeProfit is not found in the empty JSON string", CreateOrderRequestTakeProfit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrderRequestTakeProfit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrderRequestTakeProfit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
