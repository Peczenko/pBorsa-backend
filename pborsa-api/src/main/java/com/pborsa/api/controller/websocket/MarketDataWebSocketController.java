...
import com.pborsa.api.service.market.RealTimeMarketDataService;
...
public class MarketDataWebSocketController {
    ...
    public void subscribeToQuotes(
        ...
        realTimeMarketDataService.subscribeToQuotes(userId, symbols, quote -> {
            sendQuoteToUser(userId, quote);
        });
    }
