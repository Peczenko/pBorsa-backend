package com.pborsa.api.backtest.controller;
...
import com.pborsa.api.backtest.service.BacktestBalanceCalculator;
import com.pborsa.api.backtest.service.BacktestService;
...
public class BacktestController {
    ...
    private final BacktestBalanceCalculator backtestBalanceCalculator;
    ...
    public ResponseEntity<ApiResponse<List<BacktestBalancePointDto>>> getBacktestBalanceTimeline(
            ...
            @AuthenticationPrincipal FirebaseUserPrincipal principal) {
        Long targetUserId = securityService.resolveTargetUserId(userId, principal);
        return backtestBalanceCalculator.getBacktestBalanceTimeline(targetUserId, backtestId)
